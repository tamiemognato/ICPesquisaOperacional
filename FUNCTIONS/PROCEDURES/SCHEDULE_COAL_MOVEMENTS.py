...
def SCHEDULE_COAL_MOVEMENTS(dic_load_point, current_stockpile, dic_stacker_stream, times_start_of_day,dic_pad):
    ...
    print(most_to_least_total_tons_lp_to_s)
    print(lista_stacker_stream_que_pode_servir_s_no_pad)
    for i in most_to_least_total_tons_lp_to_s:                                                                          #para cada tupla de load point que s precisa de coal mov
        ...
        print(current_stockpile['time_build_start'])
        for t in (t_starts for t_starts in times_start_of_day if t_starts >= current_stockpile['time_build_start']):    #para cada t de inicio de dia
            ...
            if t in dic_load_point['t_scheduled_coal_movement'][i[0]]:                                                  #se para esse tempo já tiver carragemento atribuido para l
                ...
                if t == 99999:
                    ...
                    print("PASSEI POR AQUI")                                                                                                    #a capacidade de movimentos baseada na tonelagem vai ser X toneladas disponiveis no dia / ton por movimento de l para s, arredondado para baixo
        ...
        print(n_coalmov_lp_time_current_s)
        ...
        count = 0
        lista_tempos_mov = []
        print("Testing: ", current_stockpile['n_coalmov_lp_time'])
        while count < len(current_stockpile['n_coalmov_lp_time']):
            print('TESTING: ', current_stockpile['n_coalmov_lp_time'], 'Current_stockpile: ', current_stockpile['stockpiles'])
